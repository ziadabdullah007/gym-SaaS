...
class DashboardService:
    ...
    @staticmethod
    def gym(db,gym_id):
        active_sub=(Subscription.status=="active") & (Subscription.start_date<=date.today()) & (Subscription.end_date>=date.today())
