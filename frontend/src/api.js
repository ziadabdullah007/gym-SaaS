...
export const api={
  ...
  renewSubscription:(id,body)=>request(`/api/v1/subscriptions/${id}/renew`,{method:"POST",body}),
  cancelSubscription:(id)=>request(`/api/v1/subscriptions/${id}/cancel`,{method:"POST"}),
  freezeSubscription:(id,body)=>request(`/api/v1/subscriptions/${id}/freeze`,{method:"POST",body}),
  ...
  checkIn:(member_id,guests=[])=>request("/api/v1/attendance/check-in",{method:"POST",body:{member_id,guests}}),
  checkOut:(id)=>request(`/api/v1/attendance/${id}/check-out`,{method:"POST"}),
  guestInvitations:()=>request("/api/v1/guest-invitations"),
